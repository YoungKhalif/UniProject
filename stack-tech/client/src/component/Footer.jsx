        ...
        <div className="footer__main">
          ...
          <div className="footer__section">
            ...
            <ul className="footer__links">
              <li><Link to="/prebuilt" className="footer__link">Pre-Built Systems</Link></li>
              <li><Link to="/custom" className="footer__link">Custom PC Configurator</Link></li>
              <li><Link to="/gaming-laptops" className="footer__link">Gaming Laptops</Link></li>
              <li><Link to="/accessories" className="footer__link">Accessories</Link></li>
              <li><Link to="/peripherals" className="footer__link">Peripherals</Link></li>
              <li><Link to="/components" className="footer__link">PC Components</Link></li>
            </ul>
          </div>
          ...
          <div className="footer__section">
            ...
            <ul className="footer__links">
              <li><Link to="/support" className="footer__link">Customer Support</Link></li>
              <li><Link to="/warranty" className="footer__link">Warranty Information</Link></li>
              <li><Link to="/shipping" className="footer__link">Shipping & Returns</Link></li>
              <li><Link to="/faq" className="footer__link">FAQ</Link></li>
              <li><Link to="/build-gallery" className="footer__link">Build Gallery</Link></li>
          ...
          <div className="footer__section">
            ...
            <ul className="footer__links">
              <li><Link to="/about" className="footer__link">About Stack Technologies</Link></li>
              <li><Link to="/careers" className="footer__link">Careers</Link></li>
              <li><Link to="/press" className="footer__link">Press & Media</Link></li>
              <li><Link to="/partners" className="footer__link">Partners</Link></li>
              <li><Link to="/testimonials" className="footer__link">Customer Reviews</Link></li>
              <li><Link to="/blog" className="footer__link">Tech Blog</Link></li>
            </ul>
          </div>
          ...
          <div className="footer__section footer__newsletter">
            ...
            <div className="footer__contact">
              <div className="contact-item">
                ...
                <a href="tel:+15551234567" className="contact-link">(555) 123-TECH</a>
              </div>
              <div className="contact-item">
                <svg className="contact-item__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                ...
                <a href="mailto:info@stacktech.com" className="contact-link">info@stacktech.com</a>
              </div>
            </div>
            ...
            <div className="footer__social">
              ...
              <div className="social-links">
                <a 
                  href="https://facebook.com/stacktechnologies" 
                ...
                <a 
                  href="https://twitter.com/stacktech" 
                  className="social-link" 
                  aria-label="Twitter"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a 
                  href="https://instagram.com/stacktechnologies" 
                  className="social-link" 
                ...
                <a 
                  href="https://youtube.com/stacktechnologies" 
                  className="social-link" 
                  aria-label="YouTube"
                  target="_blank"
                  rel="noopener noreferrer"
